-------------------------------------------------------------------------
--- The legacy implementation for verifing Curry programs w.r.t. failing
...
module Legacy.Run ( runLegacy ) where
...
runLegacy :: Options -> [String] -> IO ()
runLegacy opts ms = do
...
runWith :: TermDomain a => Analysis a -> Options -> [String] -> IO ()
